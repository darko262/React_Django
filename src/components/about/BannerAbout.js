...
export function BannerAbout() {
    return (
        <section className="relative items-center flex md:h-screen bg-black w-auto  min-h-screen">
        <div className="flex md:flex-row flex-col w-full h-full">
            <div className="w-full bg-black flex flex-col justify-center  h-full md:h-auto  px-9">
